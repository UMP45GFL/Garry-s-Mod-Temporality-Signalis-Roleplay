...
LANGUAGE = {
	...
	invalidClass = "The class you provided could not be found!",
	...
	class_noWhitelist = "You do not have the whitelist for this class!",
	charNotWhitelistedClass = "%s is not whitelisted for the %s class.",
	...
	cmdPlyClassWhitelist = "Allows someone to create a character in the specified class.",
	cmdCharGetUp = "Attempts to stand back up after having fallen over.",
	cmdPlyClassUnwhitelist = "Disallows someone to create a character in the specified class.",
	...
	cmdPlyTransferClass = "Transfers someone to the specified class.",
