...
SWEP.Purpose				= "LP-265a Leuchtpistole. While not meant for combat, can be used to set enemies on fire, incapacitating them and dealing a large amount of damage over time." 
...
SWEP.PrintName				= "LP-265a Leuchtpistole"		-- Weapon name (Shown on HUD)
...
SWEP.AmmoTypeStrings = {SMG1_Grenade = "26.5mm"}
