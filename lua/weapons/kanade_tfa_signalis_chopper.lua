...
SWEP.Author 		= "Kanade"
SWEP.PrintName 		= "Small kitchen chopper"
SWEP.Spawnable 		= true
SWEP.AdminSpawnable = true
SWEP.Category 		= "Kanade's TFA Signalis"
SWEP.Pickupable 	= true

SWEP.WorldModel 	= "models/eternalis/items/weapons/kitchen/chopper_smaller.mdl"
SWEP.HoldType 		= "melee"
...
SWEP.WElements = {
	["knife"] = {
		type = "Model",
		model = "models/eternalis/items/weapons/kitchen/chopper_smaller.mdl",
