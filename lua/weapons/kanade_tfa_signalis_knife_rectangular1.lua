...
SWEP.WorldModel 	= "models/eternalis/items/weapons/kitchen/longer_stronger_knife_01.mdl"
SWEP.HoldType 		= "melee"
...
SWEP.WElements = {
	["knife"] = {
		type = "Model",
		model = "models/eternalis/items/weapons/kitchen/longer_stronger_knife_01.mdl",
